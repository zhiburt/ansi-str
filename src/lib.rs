    ...
    fn get_blocks_utf8_1() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                AnsiBlock::new("\u{1b}Ú\u{1c}\u{1c}", AnsiState::default()),
                AnsiBlock::new("{\u{1c}£\u{1c}Ì\u{1c}õ\u{1d}\u{1e}\u{1d}G\u{1d}p\u{1d}™\u{1d}Ã\u{1d}ì\u{1e}\u{16}\u{1e}@\u{1e}j\u{1e}”\u{1e}¾\u{1e}é\u{1f}\u{13}\u{1f}>\u{1f}i\u{1f}”\u{1f}¿\u{1f}ê \u{15} A l ˜ Ä ð!\u{1c}!H!u!¡!Î!û\"'\"U\"‚\"¯\"Ý#", AnsiState::default()),
            ],
        );
